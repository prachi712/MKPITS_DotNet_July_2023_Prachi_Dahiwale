...
insert into categories values(25,'five_star_prachi')
insert into categories values(14,'four_star_fire')
insert into categories values(74,'six_star_sanjana')
insert into categories values(12,'five_star_swayam')
insert into categories values(45,'eight_star_rahul')
insert into categories values(7,'ten_star_snskriti')
insert into categories values(8,'twelve_star_vishakha')
